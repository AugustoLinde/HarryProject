...
(function(IdentifyOperation5) {
  IdentifyOperation5["SET"] = "$set";
  IdentifyOperation5["SET_ONCE"] = "$setOnce";
  IdentifyOperation5["ADD"] = "$add";
  IdentifyOperation5["APPEND"] = "$append";
  IdentifyOperation5["PREPEND"] = "$prepend";
  IdentifyOperation5["REMOVE"] = "$remove";
  IdentifyOperation5["PREINSERT"] = "$preInsert";
  IdentifyOperation5["POSTINSERT"] = "$postInsert";
  IdentifyOperation5["UNSET"] = "$unset";
  IdentifyOperation5["CLEAR_ALL"] = "$clearAll";
})(IdentifyOperation || (IdentifyOperation = {}));
var SpecialEventType;
(function(SpecialEventType4) {
  SpecialEventType4["IDENTIFY"] = "$identify";
  SpecialEventType4["GROUP_IDENTIFY"] = "$groupidentify";
  SpecialEventType4["REVENUE"] = "revenue_amount";
...
var Identify = (
  ...
  function() {
    ...
    Identify3.prototype.getUserProperties = function() {
      return __assign({}, this._properties);
    };
    Identify3.prototype.set = function(property, value) {
      this._safeSet(IdentifyOperation2.SET, property, value);
      return this;
    };
    Identify3.prototype.setOnce = function(property, value) {
      this._safeSet(IdentifyOperation2.SET_ONCE, property, value);
      return this;
    };
    Identify3.prototype.append = function(property, value) {
      this._safeSet(IdentifyOperation2.APPEND, property, value);
      return this;
    };
    Identify3.prototype.prepend = function(property, value) {
      this._safeSet(IdentifyOperation2.PREPEND, property, value);
      return this;
    };
    Identify3.prototype.postInsert = function(property, value) {
      this._safeSet(IdentifyOperation2.POSTINSERT, property, value);
      return this;
    };
    Identify3.prototype.preInsert = function(property, value) {
      this._safeSet(IdentifyOperation2.PREINSERT, property, value);
      return this;
    };
    Identify3.prototype.remove = function(property, value) {
      this._safeSet(IdentifyOperation2.REMOVE, property, value);
      return this;
    };
    Identify3.prototype.add = function(property, value) {
      this._safeSet(IdentifyOperation2.ADD, property, value);
      return this;
    };
    Identify3.prototype.unset = function(property) {
      this._safeSet(IdentifyOperation2.UNSET, property, UNSET_VALUE);
      return this;
    };
    Identify3.prototype.clearAll = function() {
      this._properties = {};
      this._properties[IdentifyOperation2.CLEAR_ALL] = UNSET_VALUE;
      return this;
    };
    Identify3.prototype._safeSet = function(operation, property, value) {
    ...
    Identify3.prototype._validate = function(operation, property, value) {
...
(function(Status4) {
  ...
  Status4["Skipped"] = "skipped";
  Status4["Success"] = "success";
  Status4["RateLimit"] = "rate_limit";
  Status4["PayloadTooLarge"] = "payload_too_large";
  Status4["Invalid"] = "invalid";
  Status4["Failed"] = "failed";
  Status4["Timeout"] = "Timeout";
  Status4["SystemError"] = "SystemError";
})(Status || (Status = {}));
...
var Timeline = (
  /** @class */
  function() {
    function Timeline3(client) {
      this.client = client;
      this.queue = [];
      this.applying = false;
      this.plugins = [];
    }
    Timeline3.prototype.register = function(plugin, config2) {
      var _a, _b;
    ...
    Timeline3.prototype.deregister = function(pluginName, config2) {
      var _a;
      return __awaiter(this, void 0, void 0, function() {
        var index, plugin;
    ...
    Timeline3.prototype.reset = function(client) {
      this.applying = false;
    ...
    Timeline3.prototype.push = function(event) {
      var _this = this;
    ...
    Timeline3.prototype.scheduleApply = function(timeout2) {
      var _this = this;
      if (this.applying)
        return;
      this.applying = true;
    ...
    Timeline3.prototype.apply = function(item) {
      return __awaiter(this, void 0, void 0, function() {
    ...
    Timeline3.prototype.flush = function() {
      return __awaiter(this, void 0, void 0, function() {
...
var AmplitudeCore = (
  ...
  function() {
    ...
    AmplitudeCore3.prototype._init = function(config2) {
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
    ...
    AmplitudeCore3.prototype.runQueuedFunctions = function(queueName) {
      return __awaiter(this, void 0, void 0, function() {
    ...
    AmplitudeCore3.prototype.track = function(eventInput, eventProperties, eventOptions) {
      var event = createTrackEvent(eventInput, eventProperties, eventOptions);
      return returnWrapper(this.dispatch(event));
    };
    AmplitudeCore3.prototype.identify = function(identify2, eventOptions) {
      var event = createIdentifyEvent(identify2, eventOptions);
      return returnWrapper(this.dispatch(event));
    };
    AmplitudeCore3.prototype.groupIdentify = function(groupType, groupName, identify2, eventOptions) {
      var event = createGroupIdentifyEvent(groupType, groupName, identify2, eventOptions);
      return returnWrapper(this.dispatch(event));
    };
    AmplitudeCore3.prototype.setGroup = function(groupType, groupName, eventOptions) {
      var event = createGroupEvent(groupType, groupName, eventOptions);
      return returnWrapper(this.dispatch(event));
    };
    AmplitudeCore3.prototype.revenue = function(revenue2, eventOptions) {
      var event = createRevenueEvent(revenue2, eventOptions);
      return returnWrapper(this.dispatch(event));
    };
    AmplitudeCore3.prototype.add = function(plugin) {
      if (!this.isReady) {
    ...
    AmplitudeCore3.prototype._addPlugin = function(plugin) {
      return returnWrapper(this.timeline.register(plugin, this.config));
    };
    AmplitudeCore3.prototype.remove = function(pluginName) {
      if (!this.isReady) {
    ...
    AmplitudeCore3.prototype._removePlugin = function(pluginName) {
      return returnWrapper(this.timeline.deregister(pluginName, this.config));
    };
    AmplitudeCore3.prototype.dispatchWithCallback = function(event, callback) {
      if (!this.isReady) {
        return callback(buildResult(event, 0, CLIENT_NOT_INITIALIZED));
      }
      void this.process(event).then(callback);
    };
    AmplitudeCore3.prototype.dispatch = function(event) {
      return __awaiter(this, void 0, void 0, function() {
        var _this = this;
        return __generator(this, function(_a) {
          if (!this.isReady) {
    ...
    AmplitudeCore3.prototype.getOperationAppliedUserProperties = function(userProperties) {
    ...
    AmplitudeCore3.prototype.process = function(event) {
      return __awaiter(this, void 0, void 0, function() {
    ...
    AmplitudeCore3.prototype.setOptOut = function(optOut) {
      if (!this.isReady) {
    ...
    AmplitudeCore3.prototype._setOptOut = function(optOut) {
      if (this.config.optOut !== optOut) {
        this.timeline.onOptOutChanged(optOut);
        this.config.optOut = Boolean(optOut);
      }
    };
    AmplitudeCore3.prototype.flush = function() {
      return returnWrapper(this.timeline.flush());
    };
    AmplitudeCore3.prototype.plugin = function(name) {
...
var RemoteConfigClient = (
  ...
  function() {
    ...
    RemoteConfigClient2.prototype.fetch = function(retries, timeout2) {
      ...
      return __awaiter(this, void 0, void 0, function() {
        var interval2, failedRemoteConfigInfo, attempt, res, body, remoteConfig, error_2;
        var _this = this;
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              interval2 = timeout2 / retries;
            ...
            case 2:
              _a.trys.push([2, 8, , 9]);
              return [4, fetch(this.getUrlParams(), {
                method: "GET",
                headers: {
                  Accept: "*/*"
                }
            ...
            case 9:
              ...
              return [4, new Promise(function(resolve) {
                return setTimeout(resolve, _this.getJitterDelay(interval2));
              })];
            case 10:
              _a.sent();
              _a.label = 11;
...
var Logger = (
  ...
  function() {
    ...
    Logger3.prototype.disable = function() {
      this.logLevel = LogLevel.None;
    };
    Logger3.prototype.enable = function(logLevel) {
      if (logLevel === void 0) {
...
// node_modules/@amplitude/analytics-core/lib/esm/types/amplitude-context.js
var AmplitudeContext = (
  /** @class */
  function() {
    function AmplitudeContext2(apiKey, instanceName, serverZone, logger) {
...
var Revenue = (
  ...
  function() {
    ...
    Revenue3.prototype.setProductId = function(productId) {
      this.productId = productId;
      return this;
    };
    Revenue3.prototype.setQuantity = function(quantity) {
      if (quantity > 0) {
        this.quantity = quantity;
      }
      return this;
    };
    Revenue3.prototype.setPrice = function(price) {
      this.price = price;
      return this;
    };
    Revenue3.prototype.setRevenueType = function(revenueType) {
      this.revenueType = revenueType;
      return this;
    };
    Revenue3.prototype.setCurrency = function(currency) {
      this.currency = currency;
      return this;
    };
    Revenue3.prototype.setRevenue = function(revenue2) {
      this.revenue = revenue2;
      return this;
    };
    Revenue3.prototype.setReceipt = function(receipt) {
      this.receipt = receipt;
      return this;
    };
    Revenue3.prototype.setReceiptSig = function(receiptSig) {
      this.receiptSig = receiptSig;
      return this;
    };
    Revenue3.prototype.setEventProperties = function(properties) {
      if (isValidObject(properties)) {
        this.properties = properties;
      }
      return this;
    };
    Revenue3.prototype.getEventProperties = function() {
...
var RevenueProperty;
(function(RevenueProperty4) {
  RevenueProperty4["REVENUE_PRODUCT_ID"] = "$productId";
  RevenueProperty4["REVENUE_QUANTITY"] = "$quantity";
  RevenueProperty4["REVENUE_PRICE"] = "$price";
  RevenueProperty4["REVENUE_TYPE"] = "$revenueType";
  RevenueProperty4["REVENUE_CURRENCY"] = "$currency";
  RevenueProperty4["REVENUE"] = "$revenue";
  RevenueProperty4["RECEIPT"] = "$receipt";
  RevenueProperty4["RECEIPT_SIG"] = "$receiptSig";
...
var Config = (
  ...
  function() {
    ...
    Object.defineProperty(Config3.prototype, "optOut", {
      get: function() {
        return this._optOut;
      },
      set: function(optOut) {
...
var HistogramOptions = (
  /** @class */
  function() {
    function HistogramOptions2() {
    }
    return HistogramOptions2;
  }()
);
...
var Destination = (
  ...
  function() {
    ...
    Destination3.prototype.setup = function(config2) {
      var _a;
      return __awaiter(this, void 0, void 0, function() {
        var unsent;
        var _this = this;
    ...
    Destination3.prototype.execute = function(event) {
      var _this = this;
      if (!event.insert_id) {
    ...
    Destination3.prototype.removeEventsExceedFlushMaxRetries = function(list) {
      var _this = this;
    ...
    Destination3.prototype.resetSchedule = function() {
      this.scheduleId = null;
      this.scheduledTimeout = 0;
    };
    Destination3.prototype.flush = function(useRetry) {
      if (useRetry === void 0) {
        useRetry = false;
      }
      return __awaiter(this, void 0, void 0, function() {
    ...
    Destination3.prototype.send = function(list, useRetry) {
      if (useRetry === void 0) {
        useRetry = true;
      }
      return __awaiter(this, void 0, void 0, function() {
    ...
    Destination3.prototype.handleResponse = function(res, list) {
    ...
    Destination3.prototype.handleSuccessResponse = function(res, list) {
      this.fulfillRequest(list, res.statusCode, SUCCESS_MESSAGE);
    };
    Destination3.prototype.handleInvalidResponse = function(res, list) {
      var _this = this;
    ...
    Destination3.prototype.handlePayloadTooLargeResponse = function(res, list) {
      if (list.length === 1) {
        this.fulfillRequest(list, res.statusCode, res.body.error);
        return;
      }
    ...
    Destination3.prototype.handleRateLimitResponse = function(res, list) {
      var _this = this;
    ...
    Destination3.prototype.handleOtherResponse = function(list) {
      var _this = this;
    ...
    Destination3.prototype.fulfillRequest = function(list, code, message) {
      this.removeEvents(list);
      list.forEach(function(context2) {
        return context2.callback(buildResult(context2.event, code, message));
      });
    };
    Destination3.prototype.saveEvents = function() {
    ...
    Destination3.prototype.removeEvents = function(eventsToRemove) {
...
var MemoryStorage = (
  ...
  function() {
    ...
    MemoryStorage3.prototype.isEnabled = function() {
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(_a) {
          return [2, true];
        });
    ...
    MemoryStorage3.prototype.get = function(key) {
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(_a) {
    ...
    MemoryStorage3.prototype.getRaw = function(key) {
      return __awaiter(this, void 0, void 0, function() {
        var value;
        return __generator(this, function(_a) {
          switch (_a.label) {
    ...
    MemoryStorage3.prototype.set = function(key, value) {
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(_a) {
    ...
    MemoryStorage3.prototype.remove = function(key) {
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(_a) {
    ...
    MemoryStorage3.prototype.reset = function() {
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(_a) {
...
var BaseTransport = (
  /** @class */
  function() {
    function BaseTransport3() {
    }
    BaseTransport3.prototype.send = function(_serverUrl, _payload) {
      return Promise.resolve(null);
    };
    BaseTransport3.prototype.buildResponse = function(responseJSON) {
    ...
    BaseTransport3.prototype.buildStatus = function(code) {
...
var ServerZone;
(function(ServerZone4) {
  ServerZone4["US"] = "US";
  ServerZone4["EU"] = "EU";
  ServerZone4["STAGING"] = "STAGING";
    ...
    Object.defineProperty(ResponseWrapperXhr2.prototype, "headers", {
      get: function() {
        ...
        try {
          ...
          try {
            if (headerLines_1_1 && !headerLines_1_1.done && (_a = headerLines_1.return))
              _a.call(headerLines_1);
          } finally {
            if (e_2)
              throw e_2.error;
          }
...
var convertProxyObjectToRealObject = function(instance, queue2) {
  for (var i2 = 0; i2 < queue2.length; i2++) {
    var _a = queue2[i2], name_1 = _a.name, args = _a.args, resolve = _a.resolve;
...
var CampaignTracker = (
  ...
  function() {
    function CampaignTracker2(apiKey, options) {
      ...
      this.storageKey = getCookieName2(apiKey, MKTG2);
      this.parser = new CampaignParser2();
      ...
      this.initialEmptyValue = (_b = options.initialEmptyValue) !== null && _b !== void 0 ? _b : EMPTY_VALUE2;
    }
  ...
  return __awaiter(void 0, void 0, void 0, function() {
    ...
    return __generator(this, function(_b) {
      switch (_b.label) {
        case 0:
          _a = omitUndefined;
          return [4, new CampaignParser2().parse()];
        case 1:
...
var isCampaignEvent = function(event) {
  if (event.event_type === "$identify" && event.user_properties) {
    ...
    return Object.keys(BASE_CAMPAIGN2).every(function(value) {
...
var RemoteConfigFetch = (
  /** @class */
  function() {
    function RemoteConfigFetch3(_a) {
    ...
    RemoteConfigFetch3.prototype.getServerUrl = function() {
    ...
    RemoteConfigFetch3.prototype.completeRequest = function(_a) {
...
// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-types/lib/esm/event.js
var IdentifyOperation4;
(function(IdentifyOperation5) {
  IdentifyOperation5["SET"] = "$set";
  IdentifyOperation5["SET_ONCE"] = "$setOnce";
  IdentifyOperation5["ADD"] = "$add";
  ...
  IdentifyOperation5["UNSET"] = "$unset";
  IdentifyOperation5["CLEAR_ALL"] = "$clearAll";
})(IdentifyOperation4 || (IdentifyOperation4 = {}));
var RevenueProperty3;
(function(RevenueProperty4) {
  RevenueProperty4["REVENUE_PRODUCT_ID"] = "$productId";
  RevenueProperty4["REVENUE_QUANTITY"] = "$quantity";
  RevenueProperty4["REVENUE_PRICE"] = "$price";
  ...
  RevenueProperty4["REVENUE_CURRENCY"] = "$currency";
  RevenueProperty4["REVENUE"] = "$revenue";
})(RevenueProperty3 || (RevenueProperty3 = {}));
var SpecialEventType3;
(function(SpecialEventType4) {
  SpecialEventType4["IDENTIFY"] = "$identify";
  SpecialEventType4["GROUP_IDENTIFY"] = "$groupidentify";
  SpecialEventType4["REVENUE"] = "revenue_amount";
})(SpecialEventType3 || (SpecialEventType3 = {}));

// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-types/lib/esm/logger.js
var LogLevel3;
(function(LogLevel4) {
  LogLevel4[LogLevel4["None"] = 0] = "None";
  LogLevel4[LogLevel4["Error"] = 1] = "Error";
...
// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-types/lib/esm/plugin.js
var PluginType;
...
// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-types/lib/esm/server-zone.js
var ServerZone3;
(function(ServerZone4) {
  ServerZone4["US"] = "US";
  ServerZone4["EU"] = "EU";
  ServerZone4["STAGING"] = "STAGING";
})(ServerZone3 || (ServerZone3 = {}));

// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-types/lib/esm/status.js
var Status3;
(function(Status4) {
  Status4["Unknown"] = "unknown";
  Status4["Skipped"] = "skipped";
...
// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-types/lib/esm/transport.js
var TransportType;
...
// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-remote-config/node_modules/@amplitude/analytics-core/lib/esm/constants.js
var UNSET_VALUE2 = "-";
var AMPLITUDE_PREFIX2 = "AMP";
var STORAGE_PREFIX2 = "".concat(AMPLITUDE_PREFIX2, "_unsent");
var AMPLITUDE_SERVER_URL2 = "https://api2.amplitude.com/2/httpapi";
var EU_AMPLITUDE_SERVER_URL2 = "https://api.eu.amplitude.com/2/httpapi";
var AMPLITUDE_BATCH_SERVER_URL2 = "https://api2.amplitude.com/batch";
var EU_AMPLITUDE_BATCH_SERVER_URL2 = "https://api.eu.amplitude.com/batch";

// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-remote-config/node_modules/@amplitude/analytics-core/lib/esm/utils/valid-properties.js
var MAX_PROPERTY_KEYS2 = 1e3;
var isValidObject2 = function(properties) {
  if (Object.keys(properties).length > MAX_PROPERTY_KEYS2) {
    return false;
  }
  for (var key in properties) {
    var value = properties[key];
    if (!isValidProperties2(key, value))
      return false;
  }
  return true;
};
var isValidProperties2 = function(property, value) {
  var e_1, _a;
  if (typeof property !== "string")
    return false;
  if (Array.isArray(value)) {
    ...
    try {
      for (var value_1 = __values(value), value_1_1 = value_1.next(); !value_1_1.done; value_1_1 = value_1.next()) {
        ...
        if (Array.isArray(valueElement)) {
          ...
          isValid = isValid && isValidObject2(valueElement);
        } else if (!["number", "string"].includes(typeof valueElement)) {
          return false;
        }
        if (!isValid) {
...
// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-remote-config/node_modules/@amplitude/analytics-core/lib/esm/identify.js
var Identify2 = (
  /** @class */
  function() {
    function Identify3() {
    ...
    Identify3.prototype.set = function(property, value) {
      this._safeSet(IdentifyOperation4.SET, property, value);
      return this;
    };
    Identify3.prototype.setOnce = function(property, value) {
      this._safeSet(IdentifyOperation4.SET_ONCE, property, value);
      return this;
    };
    Identify3.prototype.append = function(property, value) {
      this._safeSet(IdentifyOperation4.APPEND, property, value);
      return this;
    };
    Identify3.prototype.prepend = function(property, value) {
      this._safeSet(IdentifyOperation4.PREPEND, property, value);
      return this;
    };
    Identify3.prototype.postInsert = function(property, value) {
      this._safeSet(IdentifyOperation4.POSTINSERT, property, value);
      return this;
    };
    Identify3.prototype.preInsert = function(property, value) {
      this._safeSet(IdentifyOperation4.PREINSERT, property, value);
      return this;
    };
    Identify3.prototype.remove = function(property, value) {
      this._safeSet(IdentifyOperation4.REMOVE, property, value);
      return this;
    };
    Identify3.prototype.add = function(property, value) {
      this._safeSet(IdentifyOperation4.ADD, property, value);
      return this;
    };
    Identify3.prototype.unset = function(property) {
      this._safeSet(IdentifyOperation4.UNSET, property, UNSET_VALUE2);
      return this;
    };
    Identify3.prototype.clearAll = function() {
      this._properties = {};
      this._properties[IdentifyOperation4.CLEAR_ALL] = UNSET_VALUE2;
      return this;
    };
    Identify3.prototype._safeSet = function(operation, property, value) {
      if (this._validate(operation, property, value)) {
    ...
    Identify3.prototype._validate = function(operation, property, value) {
      if (this._properties[IdentifyOperation4.CLEAR_ALL] !== void 0) {
        return false;
      }
      if (this._propertySet.has(property)) {
        return false;
      }
      if (operation === IdentifyOperation4.ADD) {
        return typeof value === "number";
      }
      if (operation !== IdentifyOperation4.UNSET && operation !== IdentifyOperation4.REMOVE) {
        return isValidProperties2(property, value);
      }
      return true;
    };
    return Identify3;
...
// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-remote-config/node_modules/@amplitude/analytics-core/lib/esm/utils/event-builder.js
var createTrackEvent2 = function(eventInput, eventProperties, eventOptions) {
  var baseEvent = typeof eventInput === "string" ? { event_type: eventInput } : eventInput;
  return __assign(__assign(__assign({}, baseEvent), eventOptions), eventProperties && { event_properties: eventProperties });
};
var createIdentifyEvent2 = function(identify2, eventOptions) {
  var identifyEvent = __assign(__assign({}, eventOptions), { event_type: SpecialEventType3.IDENTIFY, user_properties: identify2.getUserProperties() });
  return identifyEvent;
};
var createGroupIdentifyEvent2 = function(groupType, groupName, identify2, eventOptions) {
  var _a;
  var groupIdentify2 = __assign(__assign({}, eventOptions), { event_type: SpecialEventType3.GROUP_IDENTIFY, group_properties: identify2.getUserProperties(), groups: (_a = {}, _a[groupType] = groupName, _a) });
  return groupIdentify2;
};
var createGroupEvent2 = function(groupType, groupName, eventOptions) {
  var _a;
  var identify2 = new Identify2();
  identify2.set(groupType, groupName);
  var groupEvent = __assign(__assign({}, eventOptions), { event_type: SpecialEventType3.IDENTIFY, user_properties: identify2.getUserProperties(), groups: (_a = {}, _a[groupType] = groupName, _a) });
  return groupEvent;
};
var createRevenueEvent2 = function(revenue2, eventOptions) {
  return __assign(__assign({}, eventOptions), { event_type: SpecialEventType3.REVENUE, event_properties: revenue2.getEventProperties() });
};

// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-remote-config/node_modules/@amplitude/analytics-core/lib/esm/utils/result-builder.js
var buildResult2 = function(event, code, message) {
  if (code === void 0) {
    code = 0;
  }
  if (message === void 0) {
    message = Status3.Unknown;
  }
  return { event, code, message };
};

// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-remote-config/node_modules/@amplitude/analytics-core/lib/esm/timeline.js
var Timeline2 = (
  /** @class */
  function() {
    function Timeline3(client) {
    ...
    Timeline3.prototype.register = function(plugin, config2) {
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              return [4, plugin.setup(config2, this.client)];
            case 1:
              _a.sent();
              this.plugins.push(plugin);
              return [
          ...
          switch (_e.label) {
            ...
            case 16:
              ...
              executeDestinations = destination.map(function(plugin2) {
                var eventClone = __assign({}, event);
                return plugin2.execute(eventClone).catch(function(e3) {
                  return buildResult2(eventClone, 0, String(e3));
                });
              });
              void Promise.all(executeDestinations).then(function(_a2) {
                var _b2 = __read(_a2, 1), result = _b2[0];
...
// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-remote-config/node_modules/@amplitude/analytics-core/lib/esm/messages.js
var SUCCESS_MESSAGE2 = "Event tracked successfully";
var UNEXPECTED_ERROR_MESSAGE3 = "Unexpected error occurred";
var MAX_RETRIES_EXCEEDED_MESSAGE3 = "Event rejected due to exceeded retry count";
var OPT_OUT_MESSAGE2 = "Event skipped due to optOut config";
var MISSING_API_KEY_MESSAGE2 = "Event rejected due to missing API key";
var INVALID_API_KEY2 = "Invalid API key";
var CLIENT_NOT_INITIALIZED2 = "Client not initialized";

// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-remote-config/node_modules/@amplitude/analytics-core/lib/esm/utils/return-wrapper.js
var returnWrapper2 = function(awaitable) {
  return {
    promise: awaitable || Promise.resolve()
  };
};

// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-remote-config/node_modules/@amplitude/analytics-core/lib/esm/core-client.js
var AmplitudeCore2 = (
  /** @class */
  function() {
    function AmplitudeCore3(name) {
      ...
      this.dispatchQ = [];
      this.logEvent = this.track.bind(this);
      this.timeline = new Timeline2(this);
      this.name = name;
    }
    AmplitudeCore3.prototype._init = function(config2) {
      return __awaiter(this, void 0, void 0, function() {
    ...
    AmplitudeCore3.prototype.track = function(eventInput, eventProperties, eventOptions) {
      var event = createTrackEvent2(eventInput, eventProperties, eventOptions);
      return returnWrapper2(this.dispatch(event));
    };
    AmplitudeCore3.prototype.identify = function(identify2, eventOptions) {
      var event = createIdentifyEvent2(identify2, eventOptions);
      return returnWrapper2(this.dispatch(event));
    };
    AmplitudeCore3.prototype.groupIdentify = function(groupType, groupName, identify2, eventOptions) {
      var event = createGroupIdentifyEvent2(groupType, groupName, identify2, eventOptions);
      return returnWrapper2(this.dispatch(event));
    };
    AmplitudeCore3.prototype.setGroup = function(groupType, groupName, eventOptions) {
      var event = createGroupEvent2(groupType, groupName, eventOptions);
      return returnWrapper2(this.dispatch(event));
    };
    AmplitudeCore3.prototype.revenue = function(revenue2, eventOptions) {
      var event = createRevenueEvent2(revenue2, eventOptions);
      return returnWrapper2(this.dispatch(event));
    };
    AmplitudeCore3.prototype.add = function(plugin) {
      if (!this.config) {
      ...
      return returnWrapper2(this.timeline.register(plugin, this.config));
    };
    AmplitudeCore3.prototype.remove = function(pluginName) {
      if (!this.config) {
      ...
      return returnWrapper2(this.timeline.deregister(pluginName, this.config));
    };
    AmplitudeCore3.prototype.dispatchWithCallback = function(event, callback) {
      if (!this.config) {
        return callback(buildResult2(event, 0, CLIENT_NOT_INITIALIZED2));
      }
      void this.process(event).then(callback);
    };
    AmplitudeCore3.prototype.dispatch = function(event) {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              _a.trys.push([0, 2, , 3]);
              if (this.config.optOut) {
                return [2, buildResult2(event, 0, OPT_OUT_MESSAGE2)];
              }
              return [4, this.timeline.push(event)];
            case 1:
              result = _a.sent();
            ...
            case 2:
              ...
              message = String(e_2);
              result = buildResult2(event, 0, message);
              return [2, result];
            case 3:
              return [
                2
    ...
    AmplitudeCore3.prototype.flush = function() {
      return returnWrapper2(this.timeline.flush());
    };
    return AmplitudeCore3;
  }()
);

// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-remote-config/node_modules/@amplitude/analytics-core/lib/esm/revenue.js
var Revenue2 = (
  /** @class */
  function() {
    function Revenue3() {
    ...
    Revenue3.prototype.getEventProperties = function() {
      var eventProperties = this.properties ? __assign({}, this.properties) : {};
      eventProperties[RevenueProperty3.REVENUE_PRODUCT_ID] = this.productId;
      eventProperties[RevenueProperty3.REVENUE_QUANTITY] = this.quantity;
      eventProperties[RevenueProperty3.REVENUE_PRICE] = this.price;
      eventProperties[RevenueProperty3.REVENUE_TYPE] = this.revenueType;
      eventProperties[RevenueProperty3.REVENUE_CURRENCY] = this.currency;
...
// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-remote-config/node_modules/@amplitude/analytics-core/lib/esm/utils/chunk.js
...
// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-remote-config/node_modules/@amplitude/analytics-core/lib/esm/logger.js
var PREFIX2 = "Amplitude Logger ";
var Logger2 = (
  /** @class */
  function() {
    function Logger3() {
      this.logLevel = LogLevel3.None;
    }
    Logger3.prototype.disable = function() {
      this.logLevel = LogLevel3.None;
    };
    ...
    Logger3.prototype.log = function() {
      ...
      if (this.logLevel < LogLevel3.Verbose) {
        return;
      }
      console.log("".concat(PREFIX2, "[Log]: ").concat(args.join(" ")));
    };
    Logger3.prototype.warn = function() {
      var args = [];
      for (var _i = 0; _i < arguments.length; _i++) {
      ...
      if (this.logLevel < LogLevel3.Warn) {
        return;
      }
      console.warn("".concat(PREFIX2, "[Warn]: ").concat(args.join(" ")));
    };
    Logger3.prototype.error = function() {
      var args = [];
      for (var _i = 0; _i < arguments.length; _i++) {
      ...
      if (this.logLevel < LogLevel3.Error) {
        return;
      }
      console.error("".concat(PREFIX2, "[Error]: ").concat(args.join(" ")));
    };
    Logger3.prototype.debug = function() {
      var args = [];
      for (var _i = 0; _i < arguments.length; _i++) {
      ...
      if (this.logLevel < LogLevel3.Debug) {
        return;
      }
      console.log("".concat(PREFIX2, "[Debug]: ").concat(args.join(" ")));
    };
    return Logger3;
  }()
);

// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-remote-config/node_modules/@amplitude/analytics-core/lib/esm/config.js
var getDefaultConfig2 = function() {
  return {
    ...
    instanceName: "$default_instance",
    logLevel: LogLevel3.Warn,
    loggerProvider: new Logger2(),
    optOut: false,
    serverUrl: AMPLITUDE_SERVER_URL2,
    serverZone: ServerZone3.US,
    useBatch: false
  };
};
var Config2 = (
  ...
  function() {
    function Config3(options) {
      ...
      this.useBatch = (_d = options.useBatch) !== null && _d !== void 0 ? _d : defaultConfig.useBatch;
      this.loggerProvider.enable(this.logLevel);
      var serverConfig = createServerConfig2(options.serverUrl, options.serverZone, options.useBatch);
      this.serverZone = serverConfig.serverZone;
      this.serverUrl = serverConfig.serverUrl;
    }
    Object.defineProperty(Config3.prototype, "optOut", {
...
var getServerUrl2 = function(serverZone, useBatch) {
  if (serverZone === ServerZone3.EU) {
    return useBatch ? EU_AMPLITUDE_BATCH_SERVER_URL2 : EU_AMPLITUDE_SERVER_URL2;
  }
  return useBatch ? AMPLITUDE_BATCH_SERVER_URL2 : AMPLITUDE_SERVER_URL2;
};
var createServerConfig2 = function(serverUrl, serverZone, useBatch) {
  if (serverUrl === void 0) {
    serverUrl = "";
  }
  if (serverZone === void 0) {
    serverZone = getDefaultConfig2().serverZone;
  }
  if (useBatch === void 0) {
    useBatch = getDefaultConfig2().useBatch;
  }
  if (serverUrl) {
    return { serverUrl, serverZone: void 0 };
  }
  var _serverZone = ["US", "EU"].includes(serverZone) ? serverZone : getDefaultConfig2().serverZone;
  return {
    serverZone: _serverZone,
    serverUrl: getServerUrl2(_serverZone, useBatch)
  };
};

// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-remote-config/node_modules/@amplitude/analytics-core/lib/esm/plugins/destination.js
function getErrorMessage2(error) {
  if (error instanceof Error)
    return error.message;
  return String(error);
}
function getResponseBodyString2(res) {
  var responseBodyString = "";
  try {
    if ("body" in res) {
...
var Destination2 = (
  ...
  function() {
      ...
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              this.config = config2;
              this.storageKey = "".concat(STORAGE_PREFIX2, "_").concat(this.config.apiKey.substring(0, 10));
              return [4, (_a = this.config.storageProvider) === null || _a === void 0 ? void 0 : _a.get(this.storageKey)];
            case 1:
              unsent = _b.sent();
              this.saveEvents();
    ...
    Destination3.prototype.addToQueue = function() {
      var _this = this;
      var list = [];
      for (var _i = 0; _i < arguments.length; _i++) {
      ...
      var tryable = list.filter(function(context2) {
        ...
        void _this.fulfillRequest([context2], 500, MAX_RETRIES_EXCEEDED_MESSAGE3);
        return false;
      });
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              batches = chunk2(list, this.config.flushQueueSize);
      ...
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              if (!this.config.apiKey) {
                return [2, this.fulfillRequest(list, 400, MISSING_API_KEY_MESSAGE2)];
              }
              payload = {
                api_key: this.config.apiKey,
                events: list.map(function(context2) {
            ...
            case 1:
              _a.trys.push([1, 3, , 4]);
              serverUrl = createServerConfig2(this.config.serverUrl, this.config.serverZone, this.config.useBatch).serverUrl;
              return [4, this.config.transportProvider.send(serverUrl, payload)];
            case 2:
              res = _a.sent();
              if (res === null) {
                this.fulfillRequest(list, 0, UNEXPECTED_ERROR_MESSAGE3);
                return [
                  2
                  /*return*/
                ];
              ...
              if (!useRetry) {
                if ("body" in res) {
                  this.fulfillRequest(list, res.statusCode, "".concat(res.status, ": ").concat(getResponseBodyString2(res)));
                } else {
                  this.fulfillRequest(list, res.statusCode, res.status);
                }
                return [
            ...
            case 3:
              ...
              errorMessage = getErrorMessage2(e_1);
    ...
    Destination3.prototype.handleResponse = function(res, list) {
      var status = res.status;
      switch (status) {
        case Status3.Success: {
          this.handleSuccessResponse(res, list);
          break;
        }
        case Status3.Invalid: {
          this.handleInvalidResponse(res, list);
          break;
        }
        case Status3.PayloadTooLarge: {
          this.handlePayloadTooLargeResponse(res, list);
          break;
        }
        case Status3.RateLimit: {
          this.handleRateLimitResponse(res, list);
          break;
        }
        default: {
    ...
    Destination3.prototype.handleSuccessResponse = function(res, list) {
      this.fulfillRequest(list, res.statusCode, SUCCESS_MESSAGE2);
    };
    Destination3.prototype.handleInvalidResponse = function(res, list) {
      var _this = this;
      if (res.body.missingField || res.body.error.startsWith(INVALID_API_KEY2)) {
        this.fulfillRequest(list, res.statusCode, res.body.error);
        return;
      }
      var dropIndex = __spreadArray(__spreadArray(__spreadArray(__spreadArray([], __read(Object.values(res.body.eventsWithInvalidFields)), false), __read(Object.values(res.body.eventsWithMissingFields)), false), __read(Object.values(res.body.eventsWithInvalidIdLengths)), false), __read(res.body.silencedEvents), false).flat();
      ...
      if (retry2.length > 0) {
        this.config.loggerProvider.warn(getResponseBodyString2(res));
      }
      this.addToQueue.apply(this, __spreadArray([], __read(retry2), false));
    };
    Destination3.prototype.handlePayloadTooLargeResponse = function(res, list) {
      if (list.length === 1) {
        this.fulfillRequest(list, res.statusCode, res.body.error);
    ...
    Destination3.prototype.fulfillRequest = function(list, code, message) {
      this.saveEvents();
      list.forEach(function(context2) {
        return context2.callback(buildResult2(context2.event, code, message));
      });
    };
    Destination3.prototype.saveEvents = function() {
      if (!this.config.storageProvider) {
...
// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-remote-config/node_modules/@amplitude/analytics-core/lib/esm/storage/memory.js
var MemoryStorage2 = (
  /** @class */
  function() {
    function MemoryStorage3() {
...
// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-remote-config/node_modules/@amplitude/analytics-core/lib/esm/transports/base.js
var BaseTransport2 = (
  /** @class */
  function() {
    function BaseTransport3() {
    ...
    BaseTransport3.prototype.buildStatus = function(code) {
      if (code >= 200 && code < 300) {
        return Status3.Success;
      }
      if (code === 429) {
        return Status3.RateLimit;
      }
      if (code === 413) {
        return Status3.PayloadTooLarge;
      }
      if (code === 408) {
        return Status3.Timeout;
      }
      if (code >= 400 && code < 500) {
        return Status3.Invalid;
      }
      if (code >= 500) {
        return Status3.Failed;
      }
      return Status3.Unknown;
    };
    return BaseTransport3;
  }()
);

// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-remote-config/lib/esm/remote-config.js
var UNEXPECTED_NETWORK_ERROR_MESSAGE2 = "Network error occurred, remote config fetch failed";
var SUCCESS_REMOTE_CONFIG2 = "Remote config successfully fetched";
var MAX_RETRIES_EXCEEDED_MESSAGE4 = "Remote config fetch rejected due to exceeded retry count";
var TIMEOUT_MESSAGE2 = "Remote config fetch rejected due to timeout after 5 seconds";
var UNEXPECTED_ERROR_MESSAGE4 = "Unexpected error occurred";
var REMOTE_CONFIG_SERVER_URL2 = "https://sr-client-cfg.amplitude.com/config";
var REMOTE_CONFIG_SERVER_URL_STAGING2 = "https://sr-client-cfg.stag2.amplitude.com/config";
var REMOTE_CONFIG_SERVER_URL_EU2 = "https://sr-client-cfg.eu.amplitude.com/config";
var RemoteConfigFetch2 = (
  /** @class */
  function() {
    function RemoteConfigFetch3(_a) {
      var localConfig = _a.localConfig, configKeys = _a.configKeys;
        ...
        return __awaiter(_this, void 0, void 0, function() {
          ...
          return __generator(this, function(_e) {
            switch (_e.label) {
              case 0:
                if (sessionId === this.lastFetchedSessionId && this.attempts >= this.localConfig.flushMaxRetries) {
                  return [2, this.completeRequest({ err: MAX_RETRIES_EXCEEDED_MESSAGE4 })];
                } else if (signal.aborted) {
                  return [2, this.completeRequest({ err: TIMEOUT_MESSAGE2 })];
                } else if (sessionId !== this.lastFetchedSessionId) {
                  this.lastFetchedSessionId = sessionId;
                  this.attempts = 0;
                }
              ...
              case 2:
                res = _e.sent();
                if (res === null) {
                  return [2, this.completeRequest({ err: UNEXPECTED_ERROR_MESSAGE4 })];
                }
                parsedStatus = new BaseTransport2().buildStatus(res.status);
                switch (parsedStatus) {
                  case Status3.Success:
                    this.attempts = 0;
                    return [2, this.parseAndStoreConfig(res)];
                  case Status3.Failed:
                    return [2, this.retryFetch(signal, sessionId)];
                  default:
                    return [2, this.completeRequest({ err: UNEXPECTED_NETWORK_ERROR_MESSAGE2 })];
                }
                return [3, 4];
              case 3:
                e_1 = _e.sent();
                ...
                return [2, this.completeRequest({ err: (_d = knownError.message) !== null && _d !== void 0 ? _d : UNEXPECTED_ERROR_MESSAGE4 })];
              case 4:
                return [
                  2
                  /*return*/
        ...
        return __awaiter(_this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a2) {
            switch (_a2.label) {
              ...
              case 1:
                remoteConfig = _a2.sent();
                this.completeRequest({ success: SUCCESS_REMOTE_CONFIG2 });
                return [2, remoteConfig];
            }
          });
        });
    ...
    RemoteConfigFetch3.prototype.getServerUrl = function() {
      ...
      if (this.localConfig.serverZone === ServerZone3.STAGING) {
        return REMOTE_CONFIG_SERVER_URL_STAGING2;
      }
      if (this.localConfig.serverZone === ServerZone3.EU) {
        return REMOTE_CONFIG_SERVER_URL_EU2;
      }
      return REMOTE_CONFIG_SERVER_URL2;
    };
    RemoteConfigFetch3.prototype.completeRequest = function(_a) {
      var err = _a.err, success = _a.success;
      if (err) {
...
var createRemoteConfigFetch3 = function(_a) {
  var localConfig = _a.localConfig, configKeys = _a.configKeys;
  return __awaiter(void 0, void 0, void 0, function() {
    return __generator(this, function(_b) {
      return [2, new RemoteConfigFetch2({ localConfig, configKeys })];
    });
  });
};

// node_modules/@amplitude/plugin-autocapture-browser/node_modules/@amplitude/analytics-remote-config/lib/esm/index.js
var createRemoteConfigFetch4 = createRemoteConfigFetch3;
...
function getElementProperties(element) {
  ...
  if (!HIGHLY_SENSITIVE_INPUT_TYPES.includes(String(element.getAttribute("type"))) && !SVG_TAGS.includes(tagName)) {
    try {
      ...
      try {
        if (filteredAttributes_1_1 && !filteredAttributes_1_1.done && (_a = filteredAttributes_1.return))
          _a.call(filteredAttributes_1);
      } finally {
        if (e_1)
          throw e_1.error;
      }
...
function ensureUnicodePythonCompatible(value, nested) {
  ...
  try {
    if (value == null) {
      ...
      var elements = value.map(function(o2) {
        return ensureUnicodePythonCompatible(o2, true);
      });
...
var getEventProperties = function(actionType, element, dataAttributePrefix) {
  ...
  var properties = (_a = {}, _a[AMPLITUDE_EVENT_PROP_ELEMENT_ID] = element.getAttribute("id") || "", _a[AMPLITUDE_EVENT_PROP_ELEMENT_CLASS] = element.getAttribute("class"), _a[AMPLITUDE_EVENT_PROP_ELEMENT_HIERARCHY] = getHierarchy(element), _a[AMPLITUDE_EVENT_PROP_ELEMENT_TAG] = tag, _a[AMPLITUDE_EVENT_PROP_ELEMENT_TEXT] = getText(element), _a[AMPLITUDE_EVENT_PROP_ELEMENT_POSITION_LEFT] = rect.left == null ? null : Math.round(rect.left), _a[AMPLITUDE_EVENT_PROP_ELEMENT_POSITION_TOP] = rect.top == null ? null : Math.round(rect.top), _a[AMPLITUDE_EVENT_PROP_ELEMENT_ARIA_LABEL] = ariaLabel, _a[AMPLITUDE_EVENT_PROP_ELEMENT_ATTRIBUTES] = attributes, _a[AMPLITUDE_EVENT_PROP_ELEMENT_PARENT_LABEL] = nearestLabel, _a[AMPLITUDE_EVENT_PROP_PAGE_URL] = window.location.href.split("?")[0], _a[AMPLITUDE_EVENT_PROP_PAGE_TITLE] = typeof document !== "undefined" && document.title || "", _a[AMPLITUDE_EVENT_PROP_VIEWPORT_HEIGHT] = window.innerHeight, _a[AMPLITUDE_EVENT_PROP_VIEWPORT_WIDTH] = window.innerWidth, _a);
  if (tag === "a" && actionType === "click" && element instanceof HTMLAnchorElement) {
    properties[AMPLITUDE_EVENT_PROP_ELEMENT_HREF] = element.href;
  }
  return removeEmptyProperties(properties);
};
var addAdditionalEventProperties = function(event, type, selectorAllowlist, dataAttributePrefix, isCapturingCursorPointer) {
...
function trackClicks(_a) {
  ...
  return bufferedClicks.subscribe(function(clicks) {
    ...
    try {
      ...
      try {
        if (clicks_1_1 && !clicks_1_1.done && (_a2 = clicks_1.return))
          _a2.call(clicks_1);
      } finally {
        if (e_1)
          throw e_1.error;
...
function trackChange(_a) {
  var amplitude = _a.amplitude, allObservables = _a.allObservables, getEventProperties2 = _a.getEventProperties, shouldTrackEvent = _a.shouldTrackEvent, evaluateTriggers = _a.evaluateTriggers;
  ...
  return filteredChangeObservable.subscribe(function(changeEvent) {
    amplitude === null || amplitude === void 0 ? void 0 : amplitude.track(AMPLITUDE_ELEMENT_CHANGED_EVENT, getEventProperties2("change", changeEvent.closestTrackedAncestor));
  });
}

// node_modules/@amplitude/plugin-autocapture-browser/lib/esm/autocapture/track-action-click.js
function trackActionClick(_a) {
  var amplitude = _a.amplitude, allObservables = _a.allObservables, options = _a.options, getEventProperties2 = _a.getEventProperties, shouldTrackEvent = _a.shouldTrackEvent, shouldTrackActionClick = _a.shouldTrackActionClick;
  ...
  var filteredClickObservable = clickObservable.pipe(filter(function(click) {
    ...
    if (click.closestTrackedAncestor !== null) {
      click.targetElementProperties = getEventProperties2(click.type, click.closestTrackedAncestor);
    }
    return click;
  ...
  return actionClicks.subscribe(function(actionClick) {
    amplitude === null || amplitude === void 0 ? void 0 : amplitude.track(AMPLITUDE_ELEMENT_CLICKED_EVENT, getEventProperties2("click", actionClick.closestTrackedAncestor));
  });
}
...
var groupLabeledEventIdsByEventType = function(labeledEvents) {
  ...
  try {
    ...
    try {
      if (labeledEvents_1_1 && !labeledEvents_1_1.done && (_a = labeledEvents_1.return))
        _a.call(labeledEvents_1);
    } finally {
      if (e_1)
        throw e_1.error;
    }
...
var createLabeledEventToTriggerMap = function(triggers) {
  ...
  try {
    ...
    try {
      if (triggers_1_1 && !triggers_1_1.done && (_a = triggers_1.return))
        _a.call(triggers_1);
    } finally {
      if (e_3)
        throw e_3.error;
...
var matchLabeledEventsToTriggers = function(labeledEvents, leToTriggerMap) {
  ...
  try {
    for (var labeledEvents_2 = __values(labeledEvents), labeledEvents_2_1 = labeledEvents_2.next(); !labeledEvents_2_1.done; labeledEvents_2_1 = labeledEvents_2.next()) {
      ...
      if (triggers) {
        try {
          ...
          try {
            if (triggers_2_1 && !triggers_2_1.done && (_b = triggers_2.return))
              _b.call(triggers_2);
          } finally {
            if (e_6)
              throw e_6.error;
    ...
    try {
      if (labeledEvents_2_1 && !labeledEvents_2_1.done && (_a = labeledEvents_2.return))
        _a.call(labeledEvents_2);
    } finally {
      if (e_5)
        throw e_5.error;
    }
...
var TriggerEvaluator = (
  /** @class */
  function() {
    function TriggerEvaluator2(groupedLabeledEvents, labeledEventToTriggerMap, options) {
    ...
    TriggerEvaluator2.prototype.evaluate = function(event) {
      ...
      try {
        ...
        try {
          if (matchingTriggers_1_1 && !matchingTriggers_1_1.done && (_a = matchingTriggers_1.return))
            _a.call(matchingTriggers_1);
        } finally {
          if (e_7)
            throw e_7.error;
        }
...
var createTriggerEvaluator = function(groupedLabeledEvents, labeledEventToTriggerMap, options) {
...
var autocapturePlugin = function(options) {
  ...
  var evaluateTriggers = createTriggerEvaluator(groupedLabeledEvents, labeledEventToTriggerMap, options);
    ...
    return __awaiter(void 0, void 0, void 0, function() {
      ...
      return __generator(this, function(_b2) {
        try {
          ...
          try {
            if (subscriptions_1_1 && !subscriptions_1_1.done && (_a2 = subscriptions_1.return))
              _a2.call(subscriptions_1);
          } finally {
            if (e_1)
              throw e_1.error;
          }
...
function trackDeadClick(_a) {
  var amplitude = _a.amplitude, allObservables = _a.allObservables, getEventProperties2 = _a.getEventProperties, shouldTrackDeadClick = _a.shouldTrackDeadClick;
  var clickObservable = allObservables.clickObservable, mutationObservable = allObservables.mutationObservable, navigateObservable = allObservables.navigateObservable;
  ...
  return actionClicks.subscribe(function(actionClick) {
    ...
    amplitude.track(AMPLITUDE_ELEMENT_DEAD_CLICKED_EVENT, __assign(__assign({}, getEventProperties2("click", actionClick.closestTrackedAncestor)), deadClickEvent), { time: actionClick.timestamp });
  });
}

// node_modules/@amplitude/plugin-autocapture-browser/lib/esm/autocapture/track-rage-click.js
var RAGE_CLICK_THRESHOLD2 = DEFAULT_RAGE_CLICK_THRESHOLD;
...
function trackRageClicks(_a) {
  ...
  return clickObservable.pipe(filter(filterOutNonTrackableEvents), filter(function(click) {
    ...
    if (clickWindow.length > 0 && clickWindow[clickWindow.length - 1].closestTrackedAncestor !== click.closestTrackedAncestor) {
    ...
    if (clickWindow.length < RAGE_CLICK_THRESHOLD2) {
      return null;
    }
    var firstClick = clickWindow[0];
    var lastClick = clickWindow[clickWindow.length - 1];
    var rageClickEvent = __assign({ "[Amplitude] Begin Time": new Date(firstClick.timestamp).toISOString(), "[Amplitude] End Time": new Date(lastClick.timestamp).toISOString(), "[Amplitude] Duration": lastClick.timestamp - firstClick.timestamp, "[Amplitude] Clicks": clickWindow.map(function(click2) {
      return {
        X: click2.event.clientX,
        Y: click2.event.clientY,
        Time: click2.timestamp
      };
...
var frustrationPlugin = function(options) {
  ...
  var createObservables = function() {
    ...
    var enrichedMutationObservable = createMutationObservable().pipe(map(function(mutation) {
      return addAdditionalEventProperties(mutation, "mutation", combinedCssSelectors, dataAttributePrefix);
    }), share());
    return _a2 = {}, _a2[ObservablesEnum.ClickObservable] = clickObservable, _a2[ObservablesEnum.ChangeObservable] = new Observable(), _a2[ObservablesEnum.NavigateObservable] = navigateObservable, _a2[ObservablesEnum.MutationObservable] = enrichedMutationObservable, _a2;
  };
  var setup = function(config2, amplitude) {
    return __awaiter(void 0, void 0, void 0, function() {
      ...
      return __generator(this, function(_b2) {
        ...
        deadClickSubscription = trackDeadClick({
          ...
          getEventProperties: function(actionType, element) {
            return getEventProperties(actionType, element, dataAttributePrefix);
          },
...
var networkCapturePlugin = function(options) {
  ...
  var logger;
  var subscriptions = [];
  var addAdditionalEventProperties2 = function(event, type2) {
    var baseEvent = {
      event,
      timestamp: Date.now(),
      type: type2
  ...
  var createObservables = function() {
    ...
    var networkObservable = new Observable(function(observer) {
      var callback = new NetworkEventCallback(function(event) {
        var eventWithProperties = addAdditionalEventProperties2(event, "network");
    ...
    return __awaiter(void 0, void 0, void 0, function() {
      ...
      return __generator(this, function(_b) {
        try {
          ...
          try {
            if (subscriptions_1_1 && !subscriptions_1_1.done && (_a = subscriptions_1.return))
              _a.call(subscriptions_1);
          } finally {
            if (e_1)
              throw e_1.error;
          }
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            ...
            case 1:
              ...
              if (!isNewCampaign2(this.currentCampaign, this.previousCampaign, this.options, this.logger, isEventInNewSession))
                return [3, 3];
              this.shouldTrackNewCampaign = true;
              return [4, this.storage.set(this.storageKey, this.currentCampaign)];
            case 2:
...
var AmplitudeBrowser = (
  ...
  function(_super) {
    ...
    AmplitudeBrowser2.prototype._init = function(options) {
      var _a, _b, _c;
      return __awaiter(this, void 0, void 0, function() {
        var browserOptions, joinedConfigGenerator, attributionTrackingOptions, queryParams, ampTimestamp, isWithinTimeLimit, querySessionId, connector;
        var _this = this;
        return __generator(this, function(_d) {
          switch (_d.label) {
            case 0:
